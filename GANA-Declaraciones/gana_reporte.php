...
<div class="datos">
    <div class="img" style="width:180px; height:180px; background:#FFF; border-radius:90px; box-shadow:7px 7px 2px #dadad8; margin-right:15px;"><img src="../img/<?php echo $ddat['numdoc_pk']; ?>" style="width:180px; " ></div>
 	...
 	<div class="des">        
        <span class="nom"><?php echo $ddat['nom']." ".$ddat['priape']." ".$ddat['segape']; ?></span><br>
         ...
         <?php $dcor=condicion($c_contacto." where docmail=$ddat[numdoc_pk]"); 
              ...
              <div class="titulo"><span class="tit">Acta </span><span class="tex"> <a style="color:#4285f3; font-weight:normal;" target="_blank" href="reporte/actas/<?php echo $ddat['numdoc_pk'];?>">Documento PDF</a></span></div>     
        </div>
 </div>
...
<!------------------------------------------------------------------->        
    ...
    <div class="titulo"><span class="tit">Declaración Jurada</span><span class="tex"><a style="color:#4285f3; font-weight:normal;" target="_blank" href="reporte/declaraciones/<?php echo $ddat['numdoc_pk'];?>">Documento PDF</a></span></div>  
</div>
