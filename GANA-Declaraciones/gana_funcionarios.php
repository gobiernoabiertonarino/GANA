...
<div class="datos">
    <div class="img" style="width:100px; height:100px; background:#fff; border-radius:50px; box-shadow:7px 7px 2px #dadad8; margin-right:5px;"><img src="img/<?php echo "12750766";//$ddat['numdoc_pk'].$extimg; ?>.jpg"  style="width:100px; border-radius:50px;"/></div>
    <div class="qr" style="">
<?php 
//estas líneas se correo la primera ves o al realizar actualizaciones
	$url = $ruta_script."GANA-Declaraciones/index?reporte=1&ide=".$ddat['numdoc_pk'];
