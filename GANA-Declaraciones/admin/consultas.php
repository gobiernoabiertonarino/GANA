...
$c_datos_funcinonarios="select * from datosiniciales, gana_declaracion,institucional,cargos where numdoc_pk=ide_per_fk and numdoc_fk=numdoc_pk and codcar_fk=cod_car_pk AND niv_car='DIRECTIVO'";
$c_dependencias="select * from dependencias,subdependencias where cod_dep=cod_dep_fk ";
$c_datos="select * from datosiniciales, gana_declaracion,institucional,cargos where numdoc_pk=$_GET[ide] and  numdoc_pk=ide_per_fk and numdoc_fk=numdoc_pk and codcar_fk=cod_car_pk AND niv_car='DIRECTIVO'";
$c_contacto="select * from mails ";
